...
class KernelSnapshot extends Target {
  ...
  Future<CompilerOutput> buildImpl(Environment environment) async {
    ...
    final BuildMode buildMode = getBuildModeForName(
